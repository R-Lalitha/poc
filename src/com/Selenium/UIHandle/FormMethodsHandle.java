...
public class FormMethodsHandle {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Is displayed is used when particular object is in code base but it is
		// in visible mode or not
		...
		// If you want to validate the object which is present in web page or
		// code base
